...
import fr.univtln.gageyreboulmusial.datasources.DBCPDataSource;
import fr.univtln.gageyreboulmusial.entities.Entity;
import fr.univtln.gageyreboulmusial.exceptions.DataAccessException;
import fr.univtln.gageyreboulmusial.exceptions.NotFoundException;
...
@Log
public abstract class AbstractDAO<E extends Entity> implements fr.univtln.gageyreboulmusial.daos.DAO<E> {
